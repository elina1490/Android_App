...
public class ApplyToArgs extends ProcedureN
{
  ...
  public void checkN(Object[] paramArrayOfObject, CallContext paramCallContext)
  {
    ...
    if (i != 0)
    {
      ...
      if ((paramArrayOfObject.length > 0) && ((paramArrayOfObject[0] instanceof Procedure)))
      {
      ...
      throw MethodProc.matchFailAsException(i, (Procedure)localObject, paramArrayOfObject);
    }
  }
 ...
 * Qualified Name:     gnu.kawa.functions.ApplyToArgs
