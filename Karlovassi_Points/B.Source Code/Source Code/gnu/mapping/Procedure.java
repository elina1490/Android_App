...
public abstract class Procedure extends PropertySet
{
    ...
    throws Throwable
  {
    ...
    if ((paramCallContext.where == 0) && (i != 0))
      localObject = paramProcedure.applyN(paramCallContext.values);
    while (true)
    {
      ...
      {
      default:
        localObject = paramProcedure.applyN(paramCallContext.getArgs());
        break;
      case 0:
        localObject = paramProcedure.apply0();
        break;
      case 1:
        localObject = paramProcedure.apply1(paramCallContext.getNextArg());
        break;
      case 2:
        localObject = paramProcedure.apply2(paramCallContext.getNextArg(), paramCallContext.getNextArg());
        break;
      case 3:
        localObject = paramProcedure.apply3(paramCallContext.getNextArg(), paramCallContext.getNextArg(), paramCallContext.getNextArg());
        break;
      case 4:
        localObject = paramProcedure.apply4(paramCallContext.getNextArg(), paramCallContext.getNextArg(), paramCallContext.getNextArg(), paramCallContext.getNextArg());
      }
    }
  }
 ...
 * Qualified Name:     gnu.mapping.Procedure
