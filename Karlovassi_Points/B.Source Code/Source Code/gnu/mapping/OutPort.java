  ...
  implements Printable
{
    ...
    throws IOException
  {
    ...
    for (OutputStreamWriter localOutputStreamWriter = new OutputStreamWriter(localBufferedOutputStream); ; localOutputStreamWriter = new OutputStreamWriter(localBufferedOutputStream, localObject.toString()))
    {
      return new OutPort(localOutputStreamWriter, localPath);
  ...
  public void startLogicalBlock(String paramString1, String paramString2, int paramInt)
  {
    ...
    for (int i = paramInt; ; i = paramInt - paramString1.length())
    {
      localPrettyWriter.addIndentation(i, false);
      return;
    }
  }
 ...
 * Qualified Name:     gnu.mapping.OutPort
