...
public class ExitExp extends Expression
{
  ...
  public void compile(Compilation paramCompilation, Target paramTarget)
  {
    ...
    if (this.result == null);
    for (Object localObject = QuoteExp.voidExp; ; localObject = this.result)
    {
      ((Expression)localObject).compileWithPosition(paramCompilation, this.block.exitTarget);
  ...
  protected Expression deepCopy(IdentityHashTable paramIdentityHashTable)
  {
    ...
    if ((localExpression == null) && (this.result != null))
      return null;
    Object localObject = paramIdentityHashTable.get(this.block);
    if (localObject == null);
    for (BlockExp localBlockExp = this.block; ; localBlockExp = (BlockExp)localObject)
    {
      ExitExp localExitExp = new ExitExp(localExpression, localBlockExp);
      localExitExp.flags = getFlags();
      return localExitExp;
    }
  }
 ...
 * Qualified Name:     gnu.expr.ExitExp
