...
public class EnclosingMethodAttr extends Attribute
{
  ...
  public void assignConstants(ClassType paramClassType)
  {
    ...
    if (this.method != null)
    {
      ...
      this.class_index = localConstantPool.addClass(this.method.getDeclaringClass()).getIndex();
      this.method_index = localConstantPool.addNameAndType(this.method).getIndex();
    }
  }
 ...
 * Qualified Name:     gnu.bytecode.EnclosingMethodAttr
