  ...
  implements Externalizable
{
  ...
  public Numeric div(Object paramObject)
  {
    if ((paramObject instanceof DQuantity))
    {
      DQuantity localDQuantity = (DQuantity)paramObject;
      if (dimensions() == localDQuantity.dimensions())
        return new DFloNum(this.factor * unit().doubleValue() / (localDQuantity.factor * localDQuantity.unit().factor));
      return divide(this, localDQuantity);
    }
 ...
 * Qualified Name:     gnu.math.DQuantity
