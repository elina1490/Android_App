  ...
  public void resultReturned(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if ((paramInt1 == this.requestCode) && (paramInt2 == -1))
    {
      if ((paramIntent != null) && (paramIntent.getData() != null))
      {
        ...
        Log.i("CamcorderComponent", "Calling Camcorder.AfterPicture with clip path " + localUri.toString());
        AfterRecording(localUri.toString());
        return;
      }
 ...
 * Qualified Name:     com.google.appinventor.components.runtime.Camcorder
