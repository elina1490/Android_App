...
public final class Dates
{
  ...
  {
    return DateFormat.getDateInstance(2).format(paramCalendar.getTime());
  }

  @SimpleFunction
  public static String FormatDateTime(Calendar paramCalendar)
  {
    return DateFormat.getDateTimeInstance(2, 2).format(paramCalendar.getTime());
  }
 ...
 * Qualified Name:     com.google.appinventor.components.runtime.util.Dates
