  ...
  public void resultReturned(int paramInt1, int paramInt2, Intent paramIntent)
  {
    if ((paramInt1 == this.requestCode) && (paramInt2 == -1))
      if (!paramIntent.hasExtra("android.speech.extra.RESULTS"))
        break label51;
    label51: for (this.result = ((String)paramIntent.getExtras().getStringArrayList("android.speech.extra.RESULTS").get(0)); ; this.result = "")
    {
 ...
 * Qualified Name:     com.google.appinventor.components.runtime.SpeechRecognizer
