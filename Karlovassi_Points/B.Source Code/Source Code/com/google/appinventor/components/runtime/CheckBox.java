...
@DesignerComponent(category=ComponentCategory.BASIC, description="Checkbox that raises an event when the user clicks on it. There are many properties affecting its appearance that can be set in the Designer or Blocks Editor.", version=2)
@SimpleObject
 ...
 * Qualified Name:     com.google.appinventor.components.runtime.CheckBox
