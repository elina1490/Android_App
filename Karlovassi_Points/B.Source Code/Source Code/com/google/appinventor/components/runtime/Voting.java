...
@DesignerComponent(category=ComponentCategory.EXPERIMENTAL, designerHelpDescription="<p>The Voting component enables users to vote on a question by communicating with a Web service to retrieve a ballot and later sending back users' votes.</p>", iconName="images/voting.png", nonVisible=true, version=1)
@SimpleObject
  ...
  implements Component
{
  ...
  private void postSendBallot(String paramString1, String paramString2)
  {
    ...
    arrayOfNameValuePair[0] = new BasicNameValuePair("userchoice", paramString1);
    arrayOfNameValuePair[1] = new BasicNameValuePair("userid", paramString2);
    localWebServiceUtil.postCommand(str, "sendballot", Lists.newArrayList(arrayOfNameValuePair), local4);
  }
 ...
 * Qualified Name:     com.google.appinventor.components.runtime.Voting
