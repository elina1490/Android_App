...
public class NxtDrive extends LegoMindstormsNxtBase
{
      ...
      if (i < paramString.length())
      {
        ...
        catch (IllegalArgumentException localIllegalArgumentException)
        {
          while (true)
          {
            ...
            localForm.dispatchErrorOccurredEvent(this, "DriveMotors", 407, arrayOfObject);
          }
        }
      }
  }
  ...
  {
    long l = ()(360.0D * paramDouble / (3.141592653589793D * this.wheelDiameter));
  ...
  {
    move("MoveForward", paramInt, ()(360.0D * paramDouble / (3.141592653589793D * this.wheelDiameter)));
  }
  ...
  public void beforeDisconnect(BluetoothConnectionBase paramBluetoothConnectionBase)
  {
    if (this.stopBeforeDisconnect)
    {
      Iterator localIterator = this.driveMotorPorts.iterator();
      while (localIterator.hasNext())
        setOutputState("Disconnect", ((Integer)localIterator.next()).intValue(), 0, 2, 0, 0, 0, 0L);
    }
  }
}

/* Location:           C:\Users\er0s\Desktop\New folder (2)\classes_dex2jar.jar
 * Qualified Name:     com.google.appinventor.components.runtime.NxtDrive
